...
const TestimonialRow: FC<RowProps> = ({ data, onDelete, filteredArray, i }) => (
  <tr
    className={`${
  ...
  >
    ...
    <td>
      <span className="text-onyx text-13 rubik-regular px-4">{data?.reviewTitle}</span>
    </td>
    <td>
    ...
    <td>
      <Link
        href={`/admin/testimonials/${data?.id}`}
        className="text-onyx text-13 rubik-regular px-4"
      >
        <Edit />
      </Link>
    </td>
