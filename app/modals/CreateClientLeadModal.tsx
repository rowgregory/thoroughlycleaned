  ...
  return (
    <PublicModal show={show} onClose={reset}>
      <div className="py-20 max-w-sm mx-auto flex flex-col items-center justify-center w-full">
        ...
        <h1 className="text-2xl mb-3 font-bold text-skyAqua">Inquiry Received!</h1>
        <p className="text-center mb-7">{responseMessage}</p>

        <button type="button" onClick={reset} className="font-medium text-white bg-skyAqua hover:bg-neonSkyAqua duration-100 px-8 py-2">
          Keep Exploring
        </button>
      </div>
    </PublicModal>
