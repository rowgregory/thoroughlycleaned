  ...
  return (
    <PublicModal show={show} onClose={reset} reset={reset}>
      <div className="px-4 pt-12 480:py-20 480:mb-20 max-w-md mx-auto flex flex-col items-center justify-center w-full">
        ...
        <h1 className="font-medium text-stealthGray text-xl mt-2 mb-4">Upload video</h1>
        ...
        <Link
          ...
          target="_blank"
        >
          <span className="text-neonIce w-fit text-sm">View All Media Stored on Firebase</span>
