...
import GridSmallCircles from '@/app/icons/GridSmallCircles'

const AboutBlock = ({ textBlockMap }: any) => {
  return (
    <section className="px-4 990:px-12 xl:px-4 bg-white">
      <div className="max-w-[520px] 760:max-w-[700px] 990:max-w-[960px] 1200:max-w-[1280px] mx-auto w-full py-32 grid grid-cols-12 gap-y-8 md:gap-x-16 items-center relative">
        <div
          className={`order-2 990:order-1 bg-coolGray aspect-square flex items-center h-fit col-span-12 990:col-span-6 relative before:absolute before:content-[''] before:bg-stealthGray before:w-40 before:h-40 before:-bottom-5 before:-left-5 before:z-0`}
        >
