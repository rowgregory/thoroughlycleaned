  ...
  return (
    <div className="flex items-center justify-end 990:justify-between">
      <div className="hidden 990:flex items-center">
        <div className="flex items-center gap-2 text-white group hover:text-stealthGray duration-100">
        ...
        <span className="block w-[1px] bg-white h-5 mx-6" />
        <div className="flex items-center gap-2 text-white group hover:text-stealthGray duration-100">
      ...
      <div className="flex items-center gap-x-4">
        <button
          ...
          className="h-12 text-white 990:text-stealthGray hidden sm:flex items-center px-5 text-sm font-semibold bg-neonIce 990:bg-silver whitespace-nowrap connect-with-us"
        >
          Connect With Us
        </button>
        <div onClick={() => dispatch(setOpenNavigationDrawer())} className="block 990:hidden h-6 w-6 cursor-pointer">
          <AwesomeIcon icon={barsIcon} className="w-6 h-6 text-stealthGray" />
        </div>
      </div>
    </div>
  )
