...
const About = () => {
  return (
    <section className="max-w-screen-xl mx-auto w-full py-32 flex items-center gap-y-8 md:gap-x-12">
      <div
      ...
      >
        ...
        <Picture
          ...
          className="scaling-element aspect-square w-44 h-44 rounded-full object-cover absolute -top-12 -left-12 border-4 border-white"
          priority={true}
        />
        <Picture
          src="/images/about.jpg"
          alt="About Thoroughly Cleaned"
          className={`max-w-xl w-full h-[575px] object-cover `}
          priority={true}
        />
        <div className="bg-royal"></div>
      </div>
      <div className="flex-1">
        <div className="flex items-center gap-x-3 mb-5">
          <Picture
            ...
            priority={false}
          />
          <h1 className="uppercase text-royal poppins-semibold">About Thoroughly Cleaned</h1>
        </div>
