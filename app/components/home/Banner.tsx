...
const Banner = () => {
  ...
  return (
    <div className="bg-bannerMobile sm:bg-banner relative overflow-hidden px-4 lg:px-12 xl:px-4">
      <div className="max-w-screen-sm 990:max-w-screen-xl mx-auto w-full flex flex-col 990:flex-row lg:items-center gap-y-20 sm:gap-x-20 py-28 990:py-44">
        <div className="w-full 990:w-2/5 relative z-10">
          <div className="">
            ...
            >
              ...
              <h1 className="uppercase text-skyAqua poppins-semibold">
                Thoroughly Cleaned Provides
              </h1>
            </div>
            <h2
              className={`${
        ...
        <div className="w-full 990:w-3/5">
          <div className="w-full relative">
            ...
            />
            <div
              className="scaling-element bg-[url('/images/yellow-circles.png')]
            bg-no-repeat bg-contain w-40 h-36 absolute z-0
            990:-bottom-28 -left-10 990:left-1/2 990:translate-x-1/2"
            ></div>
          </div>
        </div>
      </div>
      <div className="hidden sm:block translate-y-element bg-yellowBubbleCorner z-0 bg-contain bg-no-repeat w-full h-full max-h-[550px] absolute -bottom-6 990:bottom-0 left-0"></div>
    </div>
  )
}
